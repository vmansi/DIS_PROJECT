...
t.test_id=r.test_id and r.login='$login_id' and t.test_id = $testid",$cn) or die(mysql_error());

echo "<h1 class=head1 align=center > <font color='red' size = '5'> Result </font> </h1>";
if(mysql_num_rows($rs)<1)
{
	echo "<br><br><h1 class=head1 align=center> You have not given any quiz of this type</h1>";
	exit;
}
